...
DEPENDENCIESCPP = main.cpp editor.cpp shader.cpp stb_image.cpp texture.cpp resource_manager.cpp glad.cpp  text_renderer.cpp box.cpp buffer.cpp piece.cpp regex.cpp file.cpp cursor.cpp
DEPS = editor.h resource_manager.h text_renderer.h box.h buffer.h piece.h regex.h file.h cursor.h
AUX = editor.o resource_manager.o text_renderer.o shader.o stb_image.o texture.o glad.o main.o box.o buffer.o piece.o regex.o file.o cursor.o
